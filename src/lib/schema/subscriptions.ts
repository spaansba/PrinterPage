...
export const printerBroadcastSubscriptions = pgTable(
  "printer_broadcast_subscriptions",
  {
    id: varchar("id", { length: 10 }).primaryKey(),
...
export type PrinterSubscription =
  typeof printerBroadcastSubscriptions.$inferInsert;
export const InsertPrinterSubscriptions = createInsertSchema(
