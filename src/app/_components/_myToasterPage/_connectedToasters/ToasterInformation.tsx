...
import {
  deleteFromBlob,
  uploadToBlob,
} from "@/lib/uploadToasterProfilePicture";
import {
  deleteToasterPairing,
  updateToasterInformation,
} from "@/lib/queries/toasterInfo";
...
function ToasterInformation({ toaster }: ToasterInformationProps) {
  ...
  const deleteToasterUserPairing = async (
    printerId: string,
